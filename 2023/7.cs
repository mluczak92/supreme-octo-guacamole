...
public class _7
{
//     private static string args = @"32T3K 765
// T55J5 684
// KK677 28
// KTJJT 220
// QQQJA 483";

    private static string args = @"K43AT 328
AAQ2A 410
45452 995
T9999 645
J7737 326
...
464J5 168";
    ...
    public static void Run()
    {
        ...
        var i = 0;
        var ordered = args.Split("\r\n")
            .Select(x =>
            {
                var split = x.Split(" ", StringSplitOptions.RemoveEmptyEntries);
                return new
                {
                    OriginalOrder = split[0],
                    Sorted = new string(split[0].OrderBy(y => dic[y]).ToArray()),
            ...
            .ThenBy(x => dic[x.OriginalOrder[3]])
